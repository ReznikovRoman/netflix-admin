...
class Base(Configuration):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': from_environ(name='NA_DB_NAME'),
            'USER': from_environ(name='NA_DB_USER'),
            'PASSWORD': from_environ(name='NA_DB_PASSWORD'),
            'HOST': from_environ(name='NA_DB_HOST'),
            'PORT': from_environ(name='NA_DB_PORT', type=int),
        },
    }
    ...
    # STATIC
    STATIC_URL = from_environ('/staticfiles/', name="NA_STATIC_URL")
    STATIC_ROOT = PROJECT_ROOT / 'staticfiles'

    # MEDIA
    MEDIA_URL = from_environ('/media/', name="NA_MEDIA_URL")
